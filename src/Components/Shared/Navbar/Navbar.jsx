...
const navOptions = (
    <>
        ...
        <li>
            <NavLink to="/contactme" className={({ isActive }) => isActive ? 'text-[#E1A34C] font-bold mx-4 text-xl' : 'mx-4 text-xl'}>Contact Me</NavLink>
        </li>
        <li>
            ...
            <div>
                    <div className=" navbar bg-[#131F33] text-white ">
                        <div className="navbar-start">
                            ...
                            <a className="btn btn-ghost normal-case text-3xl font-bold">Anantha.</a>
                        </div>
